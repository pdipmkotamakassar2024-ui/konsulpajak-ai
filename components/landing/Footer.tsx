...
const footerLinks = {
  Produk: [
    ...
    { label: "Panduan SP2DK", href: "/template-sp2dk" },
    { label: "Blog Pajak", href: "/blog" },
  ],
  Hukum: [
    { label: "UU HPP No. 7/2021", href: "#" },
    { label: "PP 20/2026 (Pajak UMKM)", href: "https://www.pajak.go.id/id/siaran-pers/pph-final-umkm-tetap-05-persen-djp-perkuat-ketepatan-sasaran" },
    { label: "UU PPh", href: "#" },
    { label: "UU PPN", href: "#" },
