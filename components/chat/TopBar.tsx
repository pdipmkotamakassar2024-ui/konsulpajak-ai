  ...
  return (
    <div className="topbar">
      ...
      <div className="topbar-actions" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px', borderRadius: '50%', backgroundColor: '#25D366', color: 'white', textDecoration: 'none', transition: 'transform 0.2s' }} onMouseEnter={(e) => (e.currentTarget as HTMLElement).style.transform = 'scale(1.1)'} onMouseLeave={(e) => (e.currentTarget as HTMLElement).style.transform = 'scale(1)'} title="Hubungi via WhatsApp">
