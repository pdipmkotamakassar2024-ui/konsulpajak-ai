...
export default function Sidebar({ isOpen, onClose, onNewChat, onSelectChat, user }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isOpen ? "" : "closed"}`}>
        {/* Logo — original image, visible on white sidebar */}
