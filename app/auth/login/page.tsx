      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: "400px", padding: "20px" }}>
        ...
        <div style={{ backgroundColor: "#FFFFFF", borderRadius: "20px", padding: "32px", boxShadow: "0 4px 24px rgba(15, 23, 42, 0.06), 0 1px 3px rgba(15, 23, 42, 0.04)", border: "1px solid var(--border-subtle)" }}>
          ...
          <p style={{ fontSize: "14px", color: "var(--text-muted)", marginBottom: "28px", textAlign: "center" }}>
            Masuk untuk melanjutkan konsultasi pajak Anda.
          </p>
          ...
          <form action={login} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "6px" }}>
                <label htmlFor="password" style={{ display: "block", fontSize: "13px", fontWeight: "600", color: "var(--text-secondary)" }}>Password</label>
                <Link href="#" style={{ fontSize: "12px", color: "var(--primary)", textDecoration: "none", fontWeight: "500" }}>Lupa password?</Link>
              </div>
              <input id="password" name="password" type="password" placeholder="••••••••" required style={{ width: "100%", padding: "11px 14px", backgroundColor: "#FFFFFF", border: "1.5px solid var(--border)", borderRadius: "10px", color: "var(--text-primary)", fontSize: "14px", outline: "none", transition: "border-color 0.2s ease" }}
                onFocus={(e) => e.currentTarget.style.borderColor = "var(--primary)"}
                onBlur={(e) => e.currentTarget.style.borderColor = "var(--border)"}
              />
            </div>
        ...
        <p style={{ textAlign: "center", fontSize: "14px", color: "var(--text-muted)", marginTop: "24px" }}>
          Belum punya akun? <Link href="/auth/register" style={{ color: "var(--primary)", fontWeight: "600", textDecoration: "none" }}>Daftar Gratis</Link>
        </p>
